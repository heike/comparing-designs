...
knowledge of general perceptual strengths and weaknesses
\citep{cleveland:1984,heer:2010}. Perceptual studies are thinly spread
for data visualization, and have, and will probably, only cover very
broad perceptual principles. Faced with design decisions for a very
specific task requires a closer level of detail. Focus groups
\citep{Mazza07} can find small problems with designs and move us
closer to a final handful of possible designs, but they lack broad
audience validatity and objective evaluation.
