...
In the case that we have multiple responses from each person (i.e. several {\it different} lineup tasks), we can estimate for their perceptual ability and correct power differences between competing designs accordingly, e.g. by modeling their power with a subject-specific random intercept.

\subsection{First Example}

\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=\linewidth]{turk4-designs.pdf} 
