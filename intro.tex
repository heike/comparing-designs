...
displays \cite{cleveland:1984,heer:2010}. Perceptual studies are
...
detail. Focus groups \cite{Mazza07} can find small problems with
designs and move us closer to a final handful of possible
designs. Usability studies and case studies
(e.g. \cite{Plaisant:2004}, \cite{Shneiderman:2006}) typically focus
...
visualizations
\cite{North:2006,Ellis:2006,Viegas:2006,Munzer:2009}. 
...
%Beta distribution for the maximum \cite{****}, which we call {\it signal strength} $\Xi$ \cite{majumder:2012}:
%\[
