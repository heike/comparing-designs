...
Deciding on the design: since wind direction is circular, we used (conditional) wind rose charts - i.e. for each of 36 wind directions we show the percentage of flights falling into specific time intervals between successive flights: 0, 1, ..., 7, and 8+ minutes.
...
In spite of the contextual circular property of wind direction, the pattern in efficiency did not seem to stand out much during the exploration process, which led us to using a corresponding  Euclidean design. Both designs were additionally equipped with a reference line at 50\%. 
