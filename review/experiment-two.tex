...
\subsection{Study II: Comparing Distribution Centers}
...
\begin{tabular}{lp{0.33\textwidth}}\\[-5pt]
...
%The reason behind this phenomenon might be visual complexity \citep{Kosslyn:2006}: dotplots are the only design that show individuals. With an increase in group size, visual complexity increases with it, which could hamper the observer in evaluating shifts.
...
Visually, density plots seem to 
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=0.95\linewidth]{conf-exp2} 
\vspace{-0.25in}
