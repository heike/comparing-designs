...
\author{Heike Hofmann, Lendie Follett, Mahbubul Majumder, Dianne Cook}
\authorfooter{
...
polar versus cartesian coordinates. The results show strong support in
favor of cartesian coordinates in finding fast and accurate answers to
...
conditions.  Amazon Mechanical Turk (MTurk) is used to conduct the studies.  The lineups
